...
define('DB_USUARIO','mypinsosere7');
define('DB_PASSWORD','sI1uYuhI');
...
//define('RUTA_URL','http://www.pinsoserp.com.mialias.net');
define('RUTA_URL','https://www.pinsosdev.com');
// NOMBRE DEL SITIO
...
//dir plantilla
define("DIR_PLANTILLAS", $_SERVER['DOCUMENT_ROOT']."/public/plantillas/plantillasEmail/");
...
define("API_GOOGLE_DRIVE",1); //1 FUNCIONA, 0 NO FUNCIONA
