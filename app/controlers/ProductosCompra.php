...
class ProductosCompra extends Controlador
{
    public function __construct()
    {
        ...
        $this->arrFieldsCreate = ['descripcion','iva','idunidad'];       
        $this->arrFieldsUpdate = ['id','descripcion','iva','idunidad'];   
        $this->modeloBase = $this->modelo('ModeloBase');  
        $this->tabla = 'productos_compras';
    ...
    {        
        ...
        $this->vista('productos/productosCompra', $datos);
    }

    public function tablaProductosCompra()
    {  
        ...
        $productos = $this->modeloProductoCompra->obtenerProductosCompraTabla($page,$order,$where,$limit);
        $totalRegistros = $this->modeloProductoCompra->obtenerTotalProductosCompra($where);
    ...
    {                      
        ...
        if(trim($_POST['descripcion']) != '' && isset($_POST['iva']) && $_POST['iva'] > 0 && isset($_POST['idunidad']) && $_POST['idunidad'] > 0 ){
    ...
    {    
        ...
        if(isset($this->fetch) && $this->fetch['id'] > 0) {
            ...
            $datosProducto = $this->modeloProductoCompra->getPurchaseProduct($idProducto);
