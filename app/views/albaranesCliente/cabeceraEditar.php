                                    ...
                                    <div class="col-md-6 col-lg-2 cont_field_prod">
                                        ...
                                        <input type='text' regexp="[a-zA-Z0-9-/_]{1,10}" class="form-control" name="numero" id="numero" value="<?php echo $datos['numero'];?>" readonly>
                                    </div>       
                                    ...
                                    <div class="col-md-6 col-lg-2 cont_field_prod">
                                        ...
                                        <input readonly class="form-control" id="zona" readonly value="<?php echo $datos['zona'];?>">
                                    </div>  

                                             
                                    <div class="col-md-6 col-lg-2 cont_field_prod">
                                        <label for="margen" class="form-label label_form_grilla">Cost</label>
                                        <input readonly class="form-control" id="margen" readonly value="<?php echo $datos['margen'];?>">
                                    </div>  
