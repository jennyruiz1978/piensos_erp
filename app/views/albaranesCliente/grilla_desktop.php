        ...
        ?>
            ...
            <tr class="thead-light">                        
                ...
                <td style="display:cell;">
                    <select class="shortWidthField inputGrillaAuto articulo" data-idorden="1" name="idArticulo[]" id="idArticulo1">
                ...
                <td>
                    <input type="text" class="shortWidthField2 inputGrillaAuto precio dblClickInput" name="precioArticulo[]" id="precioArticulo1" value="<?php echo ((isset($datos['precioDefault']))? $datos['precioDefault']: 0) ;?>">
                </td>                    
