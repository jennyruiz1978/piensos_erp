         ...
         <div class="w-full overflow-x-hidden border-t flex flex-col">
            ...
            <main class="w-full flex-grow p-6">                                             
               <div class="container mx-auto px-1 xl:px-2">
                  ...
                  <h2 class="text-2xl font-semibold leading-tight flex-1 mr-2 p-2 mt-4"><?php echo (($datos['existe'] == 1)? 'Edita':'Crear');?> albarà proveïdor</h2>            
                    
                  <div class="productos_category">

                     <div class="producto_compra productos_grilla">                               
                        <form id="formulario_crear_albaran_prov">
                           <input type="hidden" name="id" id="id" value="<?php echo $datos['idAlbaran'];?>">
                        

                           
                           <div class="cont_button_product">           
                                 <a type="submit" class="button_small_bar" id="generar_factura_proveedor"><i class="fas fa-file-invoice-dollar"></i><span>Factura</span></a>
                           </div>
                           ...
                           <div class="row">
                                 ...
                                 <?php
                                    if($datos['existe'] == 1){
                                       require(RUTA_APP . '/views/albaranesProveedor/cabeceraEditar.php');
                                    }else{
                                       require(RUTA_APP . '/views/albaranesProveedor/cabeceraCrear.php');
                                    }
                           ...
                           <?php require(RUTA_APP . '/views/albaranesProveedor/grilla_desktop.php'); ?>
                           </div>                                                                           
                           ...
                           <div class="cont_button_product">
                                 ...
                                 <a class="button_update btn_form_crear" id="cerrar_albaran" href="<?php echo RUTA_URL.'/AlbaranesProveedores';?>">Tancar</a>
...
<?php require(RUTA_APP . '/views/albaranesProveedor/formCrearFacturaProveedor.php'); ?>
