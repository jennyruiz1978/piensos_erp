            ...
            <table class="contLogo">
                <tr>
                    <td rowspan='11' class='imagen'></td>
                        <td class='titulo' style="text-transform:uppercase;"><b><?php echo $datos['tipo'];?></b></td>
                    <td class='titulo'></td>
                </tr>
                <?php
                echo "
                                    ...
                                    <tbody>";
                                        if(isset($datos['detalle']) && count($datos['detalle']) > 0){
                                            foreach ($datos['detalle'] as $fila) {
                                                echo"
                                                <tr>                                        
                                                    <td class='conceptoCol'>Dia " . date("d-m-Y",strtotime($cabecera->fecha)) .": <span>&nbsp;&nbsp;</span> ".number_format($fila->cantidad,'2',',','.')." ".$fila->unidad." de ".$fila->descripcion."</td>
