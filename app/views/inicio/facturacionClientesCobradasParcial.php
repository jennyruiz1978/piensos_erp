      ...
      <div class="w-full overflow-x-hidden border-t flex flex-col">
         ...
         <main class="w-full flex-grow p-6">    
            ...
            <div class="container mx-auto px-1 xl:px-2">
               ...
               <h2 class="text-2xl font-semibold leading-tight flex-1 mr-2 p-2 mt-4">Factures cobrades parcial - Clients</h2>
               ...
               <div class='contenedor_enlaces_dashboard flex flex-wrap gap-2 pt-2 ml-3' >
                  ...
                  <a href="<?php echo RUTA_URL."/Inicio/reportesFacturacionClientesCobradas"; ?>" class='btn_list_dw text-white px-4 py-1'>Cobrades</a>    

                  <a href="<?php echo RUTA_URL."/Inicio/reportesFacturacionClientesCobradasParcial"; ?>" class='btn_list_dw active text-white px-4 py-1'>Cobrades Parc.</a>
               ...
               <div id="container_tablas_clientes">
                  <dlm-tabla id="tablaReportesFacturasClientesCobradasParcial" url="<?php echo RUTA_URL."/Inicio/tablaReporteFacturasClientesCobradasParcial"; ?>" urlEditar= "<?php echo RUTA_URL."/Inicio/exportarExcelFacturasClientesCobradasParcial"; ?>" titulos="Id,Número,Cliente,NIF,Fecha,Venciment,B.Imp.,Dscto,IVA,Total,Situació,Cobrado,Por cobrar" hiddencol="[0,11]" crud="" fechas="fecha" botonExcel="si"></dlm-tabla>              
               </div>
