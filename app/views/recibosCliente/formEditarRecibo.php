      ...
      <div class="modal-body">
                            ...
                            <form id="formulario_editar_recibo">
                                ...
                                <div class="cont_button_product">
                                    ...
                                    <a type="submit" class="button_small_pdf_modal" id="generar_pdf"><i class="fas fa-file-pdf"></i><span></span></a> 
                                    <a class="btn_enviar_email" id="enviar_factura_proveedor"><i class="far fa-envelope"></i><span></span></a> 
