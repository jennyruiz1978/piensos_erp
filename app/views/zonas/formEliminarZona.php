<div class="modal" tabindex="-1" id="modalFormEliminarZona">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Eliminar zona</h5>
      ...
      <div class="modal-body">
                            ...
                            <form id="formulario_eliminar_zona">
                              <input type="hidden" id="idZonaEliminar" name="idZonaEliminar">
